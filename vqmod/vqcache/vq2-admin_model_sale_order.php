...
LEFT JOIN " . DB_PREFIX . "order_status oos ON (o.order_status_id = oos.order_status_id) WHERE cgd.language_id = '" . (int)$this->config->get('config_language_id') . "'";
    ...
    public function getOrderSku($option1=1, $option2=1) {
        $sku_query = $this->db->query("SELECT product_sku FROM " . DB_PREFIX . "product_sku WHERE (color_id = ".$option1." and size_id = ".$option2." ) or (color_id = ".$option2." and size_id = ".$option1." ) ");

        return $sku_query->rows;
    }
