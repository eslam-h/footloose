  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <a href="<?php echo $import; ?>" data-toggle="tooltip" title="Import" class="btn btn-success"><i class="fa fa-upload"></i></a>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'v.date_added') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'v.date_end') { ?>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $voucher['date_end']; ?></td>
                  <td class="text-right">
