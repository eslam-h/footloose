...
$data['text_salescombopge'] = $this->language->get('text_salescombopge');
        ...
        $data['text_faqcategory'] = $this->language->get('text_faqcategory');
...
$data['salescombopge'] = $this->url->link('catalog/salescombopge', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['lifestyle'] = $this->url->link('catalog/lifestyle', 'token=' . $this->session->data['token'], true);
        $data['faq'] = $this->url->link('catalog/faq', 'token=' . $this->session->data['token'], true);
        $data['faqcategory'] = $this->url->link('catalog/faqcategory', 'token=' . $this->session->data['token'], true);
