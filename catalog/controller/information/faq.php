...
//        print_r($faqcategories);
        ...
        if($faqcategories){
			foreach ($faqcategories as $result) {
				...
				$faqs = array();
				$faq_results = $this->model_catalog_faq->getFaqs($result);
...
//			} else {
//				$this->response->setOutput($this->load->view('default/template/information/faq_info.tpl', $data));
//			}
		}
