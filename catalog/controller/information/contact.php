...
class ControllerInformationContact extends Controller {
	...
	public function index() {
        ...
        $data['text_inquiries'] = $this->language->get('text_inquiries');

		$data['subm'] = $this->language->get('subm');
		$data['foot'] = $this->language->get('foot');
		$data['times'] = $this->language->get('times');


		$data['Everyday'] = $this->language->get('Everyday');////
		$data['adres'] = $this->language->get('adres');
