...
class ControllerProductSearch extends Controller {
    public function index() {
        ...
        if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
            ...
            $product_total = $this->model_catalog_productall->getTotalProducts($filter_data);

            $results = $this->model_catalog_productall->getProducts($filter_data);
...
//				}
                ...
                foreach ($this->model_catalog_productall->getProductCartOptions($result['product_id']) as $option) {
...
//                $first_option = $this->model_catalog_productall->getFirstColorOptionSku($result['product_id']);
//
//                $product_cart_images = $this->model_catalog_productall->resizeProductCartImages($result['product_id'], $first_option, $this->config->get($this->config->get('config_theme') . '_image_product_width'), $this->config->get($this->config->get('config_theme') . '_image_product_height'));


                $optionsSku = $this->model_catalog_productall->getOptionsSku($result['product_id']);

                $product_cart_images = $this->model_catalog_productall->resizeProductCartImages($result['product_id'], $optionsSku, $this->config->get($this->config->get('config_theme') . '_image_product_width'), $this->config->get($this->config->get('config_theme') . '_image_product_height'));
