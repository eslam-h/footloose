...
class ControllerthemecontrolProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
            ...
            $data['images'] = $this->model_catalog_product->resizeImages($this->request->get['product_id'], $this->config->get($this->config->get('config_theme') . '_image_popup_width'), $this->config->get($this->config->get('config_theme') . '_image_popup_height'));
