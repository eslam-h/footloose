  ...
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <div class="form-group required" style="display:none">
        ...
        <input type="text" value="Cairo" name="city" value="" placeholder="<?php echo $entry_city; ?>" id="input-payment-city" class="form-control" />
      </div>
      <div class="form-group required" style="display:none">
        <label class="control-label" for="input-payment-postcode"><?php echo $entry_postcode; ?></label>
        <input type="text" value="202" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>" id="input-payment-postcode" class="form-control" />
      </div>
      <div class="form-group required" style="display:none">
        <label class="control-label" for="input-payment-country"><?php echo $entry_country; ?></label>
        <select name="country_id" id="input-payment-country" class="form-control" value="Egypt">
          <option value=""><?php echo $text_select; ?></option>
...
<div class="checkbox">
  <label for="newsletter">
    <input type="checkbox" style="display:none" name="newsletter" value="1" id="newsletter" checked/>
