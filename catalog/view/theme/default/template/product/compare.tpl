      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr style="display:none">
            <td style="display:none"><?php echo $text_summary; ?></td>
            <?php foreach ($products as $product) { ?>
            <td class="description" style="display:none"><?php echo $product['description']; ?></td>
            <?php } ?>
          </tr>
          <tr style="display:none">
            <td style="display:none"><?php echo $text_weight; ?></td>
            <?php foreach ($products as $product) { ?>
            <td style="display:none"><?php echo $product['weight']; ?></td>
            <?php } ?>
          </tr>
          <tr style="display:none">
            <td style="display:none"><?php echo $text_dimension; ?></td>
            <?php foreach ($products as $product) { ?>
            <td style="display:none"><?php echo $product['length']; ?> x <?php echo $product['width']; ?> x <?php echo $product['height']; ?></td>
            <?php } ?>
          </tr>
        </tbody>
