	...
	<div class="row">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal space-50 content-contact">
        <div class="row">
              ...
              ?>
              <fieldset class="col-lg-4 col-md-4 col-sm-12 col-xs-12 pull-right">
                          ...
                          <div class="panel-contact-info">
                            <div class="space-30">
                                ...
                                <?php } ?>
                                    ...
                                    <div class="media" style="display:none" >
                                      ...
                                      <div class="media-body">
                                        <h4 class="media-heading"><?php echo $foot; ?></h4>
                                             <address>
                                            <?php echo $adres; ?>
                                            </address>
                                            <?php if ($geocode) { ?>
                                    ...
                                    <div style="display:none;" class="media">
                                      ...
                                      <div class="media-body">
                                        <h4 class="media-heading"><?php echo $text_telephone; ?></h4>
                                             <p style="direction:ltr;"> <?php echo $telephone; ?> </p>
                                      </div>
                                    </div>
                                ...
                                <div  class="media">
                                    <div class="media-icon pull-left"><span class="fa fa-phone fa-2x"></span></div>
                                    <div class="media-body">
                                        <h4 style="direction:ltr;" class="media-heading">010 270 111 14</h4>
                                ...
                                <div  class="media">
                                    <div class="media-icon pull-left"><span class="fa fa-phone fa-2x"></span></div>
                                    <div class="media-body">
                                        <h4 style="direction:ltr;" class="media-heading">010 676 007 70</h4>
                                        <p> <?php echo $text_inquiries; ?> </p>
                                    </div>
                                </div>
                                ...
                                <div class="media" style="padding-left: 15px;">
                                    <div class="media-icon pull-left">&emsp;</div>
                                    <div class="media-body">
                                        <h4 class="media-heading"><?php echo $text_follow; ?></h4>
...
<?php echo $captcha; ?>
                 <div class="buttons">
                  <div class="pull-right">
                    <input class="btn btn-v1" type="submit" value="<?php echo $subm; ?>" />
                  </div>
                </div>
              </fieldset>
        </div>
...
<?php endif; ?></div>
 ...
 <?php // Jquery googlemap api v3?>
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDd9QTt9S_f_9FMJSNh9MeV7gttcvyVM1A&sensor=false"></script>
