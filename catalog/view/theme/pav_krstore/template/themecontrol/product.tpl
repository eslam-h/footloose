			...
			<div class="row">
				...
				<div class="detail-container <?php echo $class; ?>">
					...
					<div class="rating">
						...
						<a href="" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><?php echo $reviews; ?></a> - <a  href="#review-form"  class="popup-with-form btn btn-2" onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;" ><?php echo $text_write; ?></a>
					</div>
					<?php } ?>
					<?php if ($price) { ?>
					<?php if (!$special) { ?>
...
$newImgPath = "ss";
						...
						<div class="form-group<?php echo ($option['required'] ? ' required' : ''); ?>">
							<label id="sizename" class="control-label" for="input-option<?php echo $option['product_option_id']; ?>"><?php echo $option['name']; ?></label>
							<select name="option[<?php echo $option['product_option_id']; ?>]" style="width:50%" id="Size" class="form-control" onchange="getSizeID();">
							...
							<div class="product-qyt-action clearfix">
								<div class="quantity-adder  pull-left">
									<div class="quantity-number pull-left">
										<input type="text" name="quantity" value="<?php echo $minimum; ?>" size="2" id="input-quantity" class="form-control text-center" min="1"/>
									</div>
									<span class="add-down add-action pull-left">
										<i class="zmdi zmdi-minus"></i>
									</span>
									<span  class="add-up add-action pull-left" onclick="plusFuntion()">
