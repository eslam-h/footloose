...
//          console.log('error');
        document.location = "index.php?route=payment/master_card/errorCallback";
      }

      function completeCallback(resultIndicator) {
        document.location = "index.php?route=payment/master_card/completeCallback";
      }
      </script>

      <script src="https://qnbalahli.test.gateway.mastercard.com/checkout/version/45/checkout.js"
