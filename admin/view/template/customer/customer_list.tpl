          ...
          <div class="row">
            <div class="col-sm-3">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                <label class="control-label" for="input-email"><?php echo 'Birth date'; ?></label>
                   <div class="input-group date">
                  <input type="text" name="filter_birth" value="<?php echo $filter_date_added; ?>" placeholder="<?php echo $entry_date_added; ?>" data-date-format="YYYY-MM-DD" id="input-date-added" class="form-control" />
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'c.date_added') { ?>
                    <a href="<?php echo $sort_date_added; ?>" class="<?php echo strtolower($order); ?>"><?php echo 'mobile'; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_date_added; ?>"><?php echo 'mobile'; ?></a>
                    <?php } ?></td>  


                  <td class="text-left"><?php if ($sort == 'c.date_added') { ?>
                    <a href="<?php echo $sort_date_added; ?>" class="<?php echo strtolower($order); ?>"><?php echo 'district'; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_date_added; ?>"><?php echo 'district'; ?></a>
                    <?php } ?></td> 
              ...
              <tbody>
                ...
                <?php if ($customers) { ?>
                <?php foreach ($customers as $customer) {  $arressR="";?>
                <tr>
                  <td class="text-center"><?php if (in_array($customer['customer_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                    <?php foreach($customer['address'] as $adress){
                  ...
                  <td class="text-left"><?php echo $arressR; ?></td>
...
$('#button-filter').on('click', function() {
  ...
  var filter_birth = $('input[name=\'filter_birth\']').val();
  
  if (filter_birth) {
    url += '&filter_birth=' + encodeURIComponent(filter_birth);
  }
