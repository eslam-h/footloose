            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left">
                    <a href="#" style=" pointer-events: none; cursor: default;"><?php echo $column_address; ?></a>
                  </td>
                  <td class="text-left">
                      <a href="#" style=" pointer-events: none; cursor: default;"><?php echo $column_telephone; ?></a>
                  </td>
              ...
              <tbody>
                ...
                <tr>
				  ...
				  <td class="text-left"><?php echo $locations['type']; ?></td>
