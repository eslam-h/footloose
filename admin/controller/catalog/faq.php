...
$data['faqs'][] = array(
	...
	$data['results'] = sprintf($this->language->get('text_pagination'), ($qa_total) ? (($page - 1) * $this->config->get('config_limit_admin')) + 1 : 0, ((($page - 1) * $this->config->get('config_limit_admin')) > ($qa_total - $this->config->get('config_limit_admin'))) ? $qa_total : ((($page - 1) * $this->config->get('config_limit_admin')) + $this->config->get('config_limit_admin')), $qa_total, ceil($qa_total / $this->config->get('config_limit_admin')));
 ...
 $data['text_form'] = !isset($this->request->get['faq_id']) ? $this->language->get('text_add') : $this->language->get('text_edit');
		...
		if (isset($this->request->post['qa_store'])) {
			$data['qa_store'] = $this->request->post['qa_store'];
		} elseif (isset($faq_info)) {
